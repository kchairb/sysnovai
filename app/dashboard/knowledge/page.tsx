        ...
        <section className="premium-panel p-4">
          ...
          <div className="mt-3 grid gap-4 xl:grid-cols-[1.4fr_1fr]">
            <div className="rounded-xl border border-accent/30 bg-accent/10 p-4">
              <p className="text-sm font-semibold">{tr("knowledge.linkFirstSetup", "Link-first quick setup")}</p>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <Button onClick={() => void onQuickSetupFromLink(true)} disabled={quickSettingUp}>
                  {quickSettingUp
            ...
            <div className="rounded-xl border border-border/70 bg-elevated/20 p-4">
              <p className="text-sm font-semibold">{tr("knowledge.workflowNext", "Next step")}</p>
              <p className="mt-1 text-xs text-secondary">
                {tr(
                  "knowledge.workflowNextDescription",
                  "After quick setup, open chatbot test to validate responses. Use advanced setup only when you need refinements."
                )}
              </p>
              <div className="mt-3 flex flex-wrap gap-2">
                <Button size="sm" variant="outline" onClick={() => setActiveFlowStep("test")}>
                  {tr("knowledge.goToTest", "Go to chatbot test")}
                </Button>
          ...
          <div className="mt-3 flex items-center justify-between gap-2 rounded-xl border border-border/70 bg-elevated/10 p-3">
          ...
          {showAdvancedSetup && (
            <div className="mt-3 grid gap-4 xl:grid-cols-2">
              <article className="rounded-xl border border-border/70 bg-elevated/15 p-4">
                <p className="text-sm font-semibold">{tr("knowledge.brandProfile", "Brand profile")}</p>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => void onAutofillFromWebsite()}
              ...
              <article className="rounded-xl border border-border/70 bg-elevated/15 p-4">
                <p className="text-sm font-semibold">{tr("knowledge.starterKit", "Starter kit details")}</p>
                <div className="mt-3 grid gap-2 sm:grid-cols-2">
                  <Input
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <Button size="sm" variant="outline" onClick={() => void onCreateBrandStarterKit()} disabled={bootstrapping}>
                    {bootstrapping
                      ? tr("knowledge.creatingStarterKit", "Creating starter kit...")
